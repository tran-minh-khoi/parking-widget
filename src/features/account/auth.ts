...
import {
  createUserWithEmailAndPassword, GoogleAuthProvider, OAuthProvider, onAuthStateChanged, sendPasswordResetEmail,
...
export type AppUser = Who & { photoURL: string | null; hasPassword: boolean };
